...
[oscam](https://trac.streamboard.tv/oscam/) is an Open Source Conditional Access Module software used for descrambling DVB transmissions using smart cards. It's both a server and a client.

This addon is based on the docker image https://docs.linuxserver.io/images/docker-oscam
...
![illustration](https://4.bp.blogspot.com/-jqnWVtMakFU/WC2pjsxEb2I/AAAAAAAACNQ/cZrqU1LojmQUwa1lpzrkypOTZOWdSjCWQCLcB/s1600/transferir.png)
