# Home assistant add-on: airsonic
...
This addon is based on the docker image https://docs.linuxserver.io/images/docker-airsonic.
...
![illustration](https://github.com/airsonic/airsonic/blob/master/contrib/assets/screenshot.png?raw=true)
