# Home assistant add-on: filezilla
...
[filezilla](https://filezilla-project.org/) is a fast and reliable cross-platform FTP, FTPS and SFTP client with lots of useful features and an intuitive graphical user interface.

This addon is based on the docker image https://docs.linuxserver.io/images/docker-filezilla.
...
![illustration](https://i2.wp.com/wpsites.net/wp-content/uploads/2019/12/ftp-client-filezilla.png?ssl=1)
