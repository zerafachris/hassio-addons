...
[digikam](https://digikam.dev/) is a Professional Photo Management with the Power of Open Source. The application can be accessed at:
http://yourhost:3000/ By default the user/pass is abc/abc, if you change your password or want to login manually to the GUI session for any reason use the following link http://yourhost:3000/?login=true

This addon is based on the docker image https://docs.linuxserver.io/images/docker-digikam.
...
![illustration](https://digikam.dev/_next/image?url=%2Fscreenshots%2Fscreen_main.jpg&w=3840&q=75)
