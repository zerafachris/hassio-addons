# Home assistant add-on: limnoria
...
[Limnoria](https://github.com/ProgVal/limnoria) is a robust, full-featured, and user/programmer-friendly Python IRC bot, with many existing plugins. Successor of the well-known Supybot.

This addon is based on the docker image https://docs.linuxserver.io/images/docker-limnoria.
...
![illustration](https://i2.wp.com/wpsites.net/wp-content/uploads/2019/12/ftp-client-limnoria.png?ssl=1)
